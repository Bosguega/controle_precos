...
function produtoPadrao(): Produto {
  return {
    id: "", // ID será gerado pelo storage
    quantidade: 1,
    unidade: "un",
    nome: "",
    marca: "",
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {produtos.map((p, idx) => {
                ...
                return (
                  <tr
                    key={p.id || idx}
                    className={`transition-colors duration-150 ${idx % 2 === 0 ? "bg-white" : "bg-gray-50"} ${isActive ? "ring-2 ring-blue-200" : "hover:bg-gray-100"}`}
                  ...
                  >
                    <td className="px-4 py-2">
                      <input
                        ...
                        className={`w-full px-2 py-1 border rounded outline-none text-sm ${hasError ? "border-red-500" : "border-gray-300"} ${isActive ? "ring-1 ring-blue-300" : ""}`}
                      />
                    </td>
                    <td className="px-4 py-2">
                      <input
                        ...
                        className={`w-full px-2 py-1 border rounded outline-none text-sm ${isActive ? "ring-1 ring-blue-300" : "border-gray-300"}`}
                      />
                    </td>
                    <td className="px-4 py-2">
                      <input
                    ...
                    <td className="px-4 py-2">
                      <input
                        type="text"
                        value={formatarMoeda(p.valorUnitario)}
                        onChange={(e) => handleChange(idx, "valorUnitario", e.target.value)}
                        className={`w-full px-2 py-1 border rounded outline-none text-sm text-right ${isActive ? "ring-1 ring-blue-300" : "border-gray-300"}`}
                      />
                    </td>
                    <td className="px-4 py-2">
                      <input
                        type="text"
                        value={formatarMoeda(p.valorTotal)}
